...
//            System.out.format("version1.velin.server.Auction created(%s). Now lets register it.\n", auction);
//            String auctionRegistryName = String.format(version1.velin.common.Utils.AUCTION_REGISTRY_NAME, auctionName);
//            Registry auctionServerRegistry = LocateRegistry.getRegistry("localhost", version1.velin.common.Utils.AUCTION_SERVER_RMI_PORT);
//            auctionServerRegistry.rebind(auctionRegistryName, auction);
//            System.out.println("version1.velin.server.Auction registered to the global AUCTION_SERVER RMI registry.\n");
...
//            System.out.printf("There exist an version1.velin.server.Auction with this name. Please try a different name.\n");
//            e.printStackTrace();
        } catch (Exception e) {
