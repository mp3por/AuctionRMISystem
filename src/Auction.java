...
public class Auction extends UnicastRemoteObject implements IAuctionRemote {
    ...
    /**
     * Basic Auction Constructor
     *
     * @param auctionName The Auction Name
     * @throws IOException If there is a problem opening 'log-Auction.txt' file used for logging
     */
    ...
    /**
     * A method to be used by the AuctionServer to get all active AuctionsItems
     *
    ...
    private static class FinishedAuctionItem {
        ...
        private void removeFromReady() {
            ...
            this.LOGGER.log(DEFAULT_LOG_LEVEL, "AUCTION: AuctionItem (" + this.auctionItemId + ") expired and can not be reclaimed anymore.");
        }
    }
}
