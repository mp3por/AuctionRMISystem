...
public class Utils {
    ...
    public static final String AUCTION_REGISTRY_NAME = "rmi://localhost/velin.server.AuctionServer/";
    public static final String AUCTION_SERVER_HOST = "localhost";
    public static final String AUCTION_SERVER_NAME = "velin.server.AuctionServer";
