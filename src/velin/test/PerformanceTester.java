...
//        Object o = auctionServerRegistry.lookup("rmi://" + velin.common.Utils.AUCTION_SERVER_HOST + "/" + velin.common.Utils.AUCTION_SERVER_NAME);
        ...
        System.out.println("Testing velin.server.Auction: " + auction.getName());
    ...
    private void testCreateAuctionItem() {
        ...
        try {
            ...
            System.out.println("velin.server.Auction unreachable. Stop testing!");
